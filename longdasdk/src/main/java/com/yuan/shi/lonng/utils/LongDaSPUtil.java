...
public class LongDaSPUtil
{
         ...
         * @param context 上下文
         */
        public LongDaSPUtil(Context context) {
         ...
         * @param filename 文件名
         */
        public LongDaSPUtil(Context context, String filename) {
         ...
         * @param sp sp
         */
        public LongDaSPUtil(Context context, SharedPreferences sp) {
