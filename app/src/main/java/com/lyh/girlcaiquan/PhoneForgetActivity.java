 ...
 */
public class PhoneForgetActivity extends Activity{
    ...
    private void init() {
        ...
        findViewById(R.id.phone_login).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PhoneForgetActivity.this, PhoneLoginActivity.class));
            }
        });
        ...
        findViewById(R.id.phone_regi).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PhoneForgetActivity.this, PhoneRegisterActivity.class));
            }
        });
    }
    ...
    private void procGetPassword() {
        ...
        LongDaGame.getPassword(this, phone, code, mainLoginListener);
    ...
    private class MainLoginListener implements LongDaLoginListener {
        ...
        public void onGetPassword(int responseCode, String errorMsg, JSONObject data) {
            ...
            // userName, userid
            password = data.optString("passwd");
            String phone = data.optString("phone");
            AlertDialog.Builder builder = new AlertDialog.Builder(PhoneForgetActivity.this);
            builder.setMessage("获取密码:"
                    + "\n状态=" + tip
                    + "\n手机号码=" + phone
                    + "\n密码=" + password);
